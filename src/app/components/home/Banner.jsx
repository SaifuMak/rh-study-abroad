...
function Banner() {
  ...
  const buttonRef = useGsapFadeIn({start: "top 99%", delay:0.2})
    ...
    >
      ...
      <div className={`${inriaSans.className} w-11/12 xl:w-9/12  flex items-end mx-auto  h-full`}>
        <div className="  xl:pb-28 lg:pb-20 pb-6   font-semibold w-full">
          <h1 ref={contentRef} className={`${istokWeb.className} text-3xl opacity-0 md:text-5xl lg:text-7xl xl:leading-20 `}>Study Abroad,<br />
            Live your Dream Life</h1>
          <div ref={buttonRef} className="flex opacity-0 mt-5 items-center max-lg:text-xs  space-x-5">
